...
export default function Discover5() {
    ...
    <p style={{color: "#fff", fontSize: "3rem", fontFamily: "'Bebas Neue', sans-serif"}}>AMG GT</p>
    <p style={{color: "#fff", fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.5rem", textDecoration: "underline"}}>Price: 3.839.999 kr</p>
  </div>
